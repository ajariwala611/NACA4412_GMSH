...
gmsh.model.geo.synchronize()
# Recombine all the surfaces
for sid in b:
    gmsh.model.mesh.setRecombine(2, sid)
    
# gmsh.option.setNumber("Mesh.RecombineAll",   1)  # recombine tri → quad
# gmsh.option.setNumber("Mesh.RecombinationAlgorithm",   0)  #

gmsh.option.setNumber("Mesh.Algorithm",      8)  # quad-delaunay (fast)
...
mesh_filename = os.path.join(script_dir, "naca_boundary_layer_3d.msh")
cgns_filename = os.path.join(script_dir, "naca_boundary_layer_3d.cgns")
